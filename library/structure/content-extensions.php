		...
		<article>
			...
			<header class="entry-header">
  			...
  			<div class="entry-meta-bar clearfix">
    			...
    			<?php
    			echo '<a class="readmore" href="' . get_permalink() . '" title="'.the_title( '', '', false ).'">'.__( 'Подробнее', 'travelify' ).'</a>';
    			?>
    		</div>
...
<!-- yandex share -->
    		...
    		<div class="yashare-auto-init" data-yashareL10n="ru" data-yashareType="big" data-yashareQuickServices="vkontakte,facebook,twitter,odnoklassniki" data-yashareTheme="counter"></div><!-- /yandex share --></div>
  			<?php do_action( 'travelify_after_post_header' ); ?>
  			...
  			<div class="entry-content clearfix">
    			...
    			<!-- yandex share -->
    		<script type="text/javascript" src="//yastatic.net/share/share.js" charset="utf-8"></script><div class="yashare-auto-init" data-yashareL10n="ru" data-yashareType="big" data-yashareQuickServices="vkontakte,facebook,twitter,odnoklassniki" data-yashareTheme="counter"></div><!-- /yandex share -->
  			</div>
...
?>
	<section id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<article>
  		...
  		<div class="share"><!-- yandex share -->
  		  		<script type="text/javascript" src="//yastatic.net/share/share.js" charset="utf-8"></script><div class="yashare-auto-init" data-yashareL10n="ru" data-yashareType="big" data-yashareQuickServices="vkontakte,facebook,twitter,odnoklassniki" data-yashareTheme="counter"></div><!-- /yandex share --></div>
  		...
  		<?php do_action( 'travelify_before_post_meta' ); ?>
  			...
  			<div class="entry-content clearfix">
               ...
               ?>
               <!-- yandex share -->
    		<script type="text/javascript" src="//yastatic.net/share/share.js" charset="utf-8"></script><div class="yashare-auto-init" data-yashareL10n="ru" data-yashareType="big" data-yashareQuickServices="vkontakte,facebook,twitter,odnoklassniki" data-yashareTheme="counter"></div><!-- /yandex share --><br>
  			</div>
...
if ( ! function_exists( 'travelify_theloop_for_single_video' ) ) :
/**
 * Fuction to show the single video post content.
 */
function travelify_theloop_for_single_video() {
	global $post;
	...
	if( have_posts() ) {
		while( have_posts() ) {
			...
			do_action( 'travelify_before_post' );
?>
	<section id="post-<?php the_ID(); ?>" class="single-video">
		<article>
  		...
  		<div class="share"><!-- yandex 12 share -->
  		  		<script type="text/javascript" src="//yastatic.net/share/share.js" charset="utf-8"></script><div class="yashare-auto-init" data-yashareL10n="ru" data-yashareType="big" data-yashareQuickServices="vkontakte,facebook,twitter,odnoklassniki" data-yashareTheme="counter"></div><!-- /yandex 12 share --></div>
  		...
  		<?php do_action( 'travelify_before_post_meta' ); ?>
  			...
  			<div class="entry-meta-bar clearfix">
    			<div class="entry-meta">
	    				<?php if ( is_user_logged_in() ) { ?><span class="author"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author(); ?></a></span><?php } ?>
	    				<span class="date"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( get_the_time() ); ?>"><?php the_time( get_option( 'date_format' ) ); ?></a></span>
	    				<?php if( has_category() ) { ?>
	             		<span class="category"><?php the_category(', '); ?></span>
	             	<?php } ?>
  			...
  			<div class="entry-content clearfix">
  			<iframe width="625" height="415" src="//www.youtube.com/embed/<?php echo get_post_meta($post->ID, 'youtube_id', true); ?>" frameborder="0" allowfullscreen></iframe>
    			<?php 
    			if( is_single() ) {
						$tag_list = get_the_tag_list( '', __( ', ', 'travelify' ) );
  			...
  			<div class="share"> <!-- yandex share -->
              	<script type="text/javascript" src="//yastatic.net/share/share.js" charset="utf-8"></script><div class="yashare-auto-init" data-yashareL10n="ru" data-yashareType="big" data-yashareQuickServices="vkontakte,facebook,twitter,odnoklassniki" data-yashareTheme="counter"></div></div><!-- /yandex share --><br>
	...
	<section id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<article>
			...
			if( has_post_thumbnail() ) {
  			...
  			<div class="entry-meta-bar clearfix">
    			<div class="entry-meta">
	    				<?php if ( is_user_logged_in() ) { ?><span class="author"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php the_author(); ?></a></span><? } ?>
	    				<span class="date"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( get_the_time() ); ?>"><?php the_time( get_option( 'date_format' ) ); ?></a></span>
	    				<?php if( has_category() ) { ?>
	             		<span class="category"><?php the_category(', '); ?></span>
	             	<?php } ?>
			...
			<header class="entry-header">
  			...
  			<div class="entry-content clearfix">
    			<?php
    				...
    				the_content( __( 'Подробнее', 'travelify' ) );
...
if ( ! function_exists( 'travelify_theloop_for_video_archive' ) ) :
/**
 * Fuction to show the archive loop video-content.
 */
function travelify_theloop_for_video_archive() {
	global $post; ?>

<div class="page-title-wrap">
	    		<div class="container clearfix">
	    							   <h3 class="page-title">Видео</h3>
				</div>
	    	</div>
	<?php
...
?>
	...
	<section id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<article class="video-block">
			...
			<?php
				$id_youtube = get_post_meta($post->ID, 'youtube_id', true);
				$image = '';
	     		$title_attribute = apply_filters( 'the_title', get_the_title( $post->ID ) );
	     		$image .= '<figure class="post-featured-image-video">';
	  			$image .= '<a href="' . get_permalink() . '" title="'.the_title( '', '', false ).'">';
	  			$image .= '<img  src="http://img.youtube.com/vi/'.$id_youtube.'/0.jpg" alt="'.the_title( '', '', false ).'">'.'</a>';
	  			$image .= '</figure>';
